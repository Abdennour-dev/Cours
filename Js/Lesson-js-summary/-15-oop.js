...
function User(id, username, salary) {                         الطريقة العادية 
    this.i = id;
    this.u = username;
    this.s = salary + 1000;
  }
...
class User { 
    constructor(id, username, salary) {                        الكتابة بالطريقة الجديدة
      this.i = id;
      this.u = username;
      this.s = salary + 1000;
    }
...
class User {
    constructor(id, username, salary) {                                   Properties And Methods   مثال عملي للتعامل مع 
      // Properties
      this.i = id;
