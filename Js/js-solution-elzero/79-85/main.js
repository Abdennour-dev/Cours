...
/* In oreder to find an object length we use :
          Syntax:

          objectLength = Object.keys(myObject).length
          
          */
let objectLength = Object.keys(myFavGames).length;

for (let i = 0; i < objectLength; i++) {
  // Object.keys(myFavGames)[i] to reach the object's nested objects;
  ...
  if (myFavGames[Object.keys(myFavGames)[i]].hasOwnProperty("bestThree")) {
    // Way 2 : if ( myFavGames[getKeys].bestThree  ) {}
